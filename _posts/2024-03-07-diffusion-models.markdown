...
$$
\partial_t p_Z=\text{Re} \frac{1}{2}\sum_{i,j}\frac{\partial^2 p_Z(\sigma\sigma^\top)_{ij}}{\partial z_i \partial z_j}+frac{\partial^2 p_Z(\sigma\sigma^\dagger)_{ij}}{\partial z_i \partial \bar{z_j}} - \sum_{i=1}^n \frac{\partial fp_Z}{\partial z_i}.
$$
